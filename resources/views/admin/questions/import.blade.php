...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.questions.importQuestion") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <div class="mb-2">
                    <a href="{{ asset('/format/Questions.xlsx') }}" download="" class="btn btn-primary">Download Format <i class="far fa-file-excel"></i></a>
                </div>
                <label for="excel">Add Excel File for Question</label>
                <div class=" mb-2">
